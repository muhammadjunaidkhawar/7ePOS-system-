      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="w-64 space-y-3">
            <button className="w-full flex items-center gap-2 bg-[#FF9500] text-black text-sm px-4 py-3 rounded-lg">
              <i className="fa-solid fa-user"></i> My Profile
            </button>
            <button className="w-full flex items-center gap-2 bg-[#2a2a2a] text-white text-sm px-4 py-3 rounded-lg hover:bg-[#FF9500] hover:text-black">
